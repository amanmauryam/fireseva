...
from .views import home, find_contractors,login_view,signup_view,logout_view, about, why_fireseva,contractor_detail,blog_detail, blog, contact, all_service, submit_enquiry
urlpatterns = [
    path('', home, name='home'),
